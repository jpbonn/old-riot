// See ../vendor/LICENSE for license details.

/*
 * from:
 * https://github.com/sifive/freedom-e-sdk/blob/master/bsp/env/freedom-e300-hifive1/init.c
 */
...
static void use_default_clocks(void)
{
  // Turn off the LFROSC
...
/**
 * Board_init needs to be called before __libc_init_array in start.s
 * to initial clocks prior to UART being initialized.
 */
void board_init(void)
{
      ...
      /* Setup the trap handling vector */
	  write_csr(mtvec, &trap_entry);
